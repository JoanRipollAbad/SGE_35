# -*- coding: utf-8 -*-
{
    'name': "Biblioteca Comics Extendida",  # Titulo del módulo
    'summary': "Gestionar comics :) (Version extendida)",  # Resumen de la funcionaliadad
    'description': """
Gestor de bibliotecas (Version Extendida)
==============
    """,  
