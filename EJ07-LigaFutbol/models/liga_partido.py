...
class LigaPartido(models.Model):
    ...
    def action_sumar_dos_goles_casa(self):
        """
        Suma 2 goles a todos los equipos de casa y recalcula la clasificación.
        """
        for partido in self.search([]):
            partido.goles_casa += 2
        # Llama a la función de actualización de clasificación.
        self.actualizoRegistrosEquipo()
        
    def action_sumar_dos_goles_fuera(self):
        """
